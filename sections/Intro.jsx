        ...
        >
          ...
          >
            ...
            <div className="mt-5 md:mt-10 flex gap-3">
              {/* Hire Me Button */}
              <Link
                className="text-white text-xl animate-pulse font-semibold rounded bg-red-400 hover:bg-red-500 px-2 py-1"
                href={"#getInTouch"}
              >
                Hire me
              </Link>
              ...
              <Link
                ...
                href="https://drive.google.com/file/d/19eVlUaMsKnQCv0hz3qLKh-cB4WMHlU3x/view?usp=sharing"
                target="_blank"
              >
                Download CV
              </Link>
